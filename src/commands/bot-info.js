...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    run: async (interaction, client) => {
        ...
        .addFields(
            { name: ':computer: System', value: `> Uptime: ${uptime2}\n> Ram: \`\`${ram}\`\`\n> CPU: \`\`${cpu}\`\`\n> Total Command Using: ${totalCommand}\n` },
            { name: ':bar_chart: General', value: `> Servers: \`\`${servers}\`\`\n> Users: \`\`${users}\`\`` },       
		    { name: ':speech_balloon: Latecy', value: `> Latecy: \`\`${latecy}\`\`\n> API Latecy: \`\`${api_latecy}\`\`` },
            { name: ':information_source: Versions', value: `> DiscordJS : \`\`${version}\`\`\n> NodeJS : \`\`${process.version}\`\`\n> Mongoose: \`\`${mongoose}\`\`` }
        ) 
